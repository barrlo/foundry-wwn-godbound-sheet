import {BarrloActorSheet} from './actor-sheet.js';
 ...
 */
export class BarrloActorSheetCharacter extends BarrloActorSheet {
    constructor(...args) {
        super(...args);
    }
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            ...
            template: 'modules/foundry-wwn-godbound-sheet/scripts/templates/actors/character-sheet.html',
            width: 755,
            height: 625,
            resizable: false,
            tabs: [
    ...
    generateScores() {
        new BarrloCharacterCreator(this.actor, {
    ...
    adjustCurrency() {
        new BarrloAdjustCurrency(this.actor, {
    ...
    async _chooseLang() {
        ...
        let templateData = {choices: choices},
            dlg = await renderTemplate('systems/wwn/templates/actors/dialogs/lang-create.html', templateData);
    ...
    async _chooseItemType(choices = {focus: 'focus', ability: 'ability'}) {
        let templateData = {types: choices},
            dlg = await renderTemplate('systems/wwn/templates/items/entity-create.html', templateData);
        //Create Dialog window
        return new Promise(resolve => {
            new Dialog({
    ...
    _onShowModifiers(event) {
        event.preventDefault();
        new BarrloCharacterModifiers(this.actor, {
            top: this.position.top + 40,
            left: this.position.left + (this.position.width - 400) / 2
        }).render(true);
    }
    ...
    activateListeners(html) {
        ...
        html.find('#miracle-button').on('click', evt => onMiracleClick(evt, this.actor));
